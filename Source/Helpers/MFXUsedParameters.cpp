...
// not using this, but struct in plugininProcessor instead
juce::String MFXParameterValueText[] =
{
    // ms, note sync, %, Hz, KHz, non, dB
    ...
    "Time Left", // Crazy delay
    "Time Right", //  Crazy delay
    "Feedback Left", //  Crazy delay
    "Feedback Right", //  Crazy delay
    "Link Time", //
    "Link FB", //
    "Transition", //  Crazy delay
    //"Rate", //  ModLFO
    //"Amount", //  ModLfo
    "Time Mode", // Delay1
    "Time Mode", // Delay2 MAIN
    //"Reverb", // DelayLine add reverb
    "Phase", // Chorus center delay/ Phase
    "Feedback", // Chorus feedback
    "Rate", // Phaser rate
    "Depth", // Phaser depth
    "Frequency", // Phaser
    ...
    /*-------------midi input LFO retrigger------*/
    "midi_lfo1_retrigger",      // not visual
    "midi_lfo2_retrigger",
